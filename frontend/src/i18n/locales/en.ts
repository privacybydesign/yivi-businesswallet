export const en = {
  ...
  auditLog: {
    ...
    actions: {
      ...
      approvalDeclined: "Declined request",
      approvalExpired: "Approval request expired",
      approvalAutoApproved: "Auto-approved by policy",
      approvalAutoDeclined: "Auto-declined by policy",
      policyCreated: "Created policy",
      policyUpdated: "Updated policy",
      policyRevoked: "Revoked policy",
    },
  },
  memberInvite: {
    title: "Invite member",
