export const en = {
  ...
  themeSettings: {
    title: "Branding",
    intro:
      "Give this organization's wallet its own look. Set the brand colours and, optionally, the wider palette; the logo replaces the Yivi wordmark. Palette colours are automatically kept readable (WCAG AA) in both light and dark mode. Leave a field empty to keep the default.",
    brandGroup: "Brand",
    paletteGroup: "Palette (optional)",
    primaryColor: "Primary colour",
    accentColor: "Accent colour",
    textColor: "Text colour",
    surfaceColor: "Surface tint",
